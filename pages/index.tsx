...
const Home = () => {
    return (
        <Layout>
            ...
            {/* Projects Section */}
            <section id="projects" className="bg-gray-50 py-20 dark:bg-slate-950">
            ...
            <section id="about" className="py-20">
                <div className="container mx-auto px-4">
                    ...
                    <div className="max-w-3xl mx-auto mb-16">
                        <p className="mb-8 text-center text-lg text-gray-700 dark:text-slate-300">
                        ...
                        <div className="mb-12 flex flex-wrap justify-center gap-6 md:gap-8">
                            <a
                                ...
                                className="flex flex-col items-center text-gray-700 hover:text-primary dark:text-slate-300 dark:hover:text-sky-300"
                            >
                    ...
                    <h3 className="mb-8 text-center text-2xl font-semibold dark:text-slate-100">Technical Skills</h3>
            ...
            {/* Contact Section */}
            <section id="contact" className="bg-gray-50 py-20 dark:bg-slate-950">
                <div className="container mx-auto px-4">
                    <h2 className="section-title">Get In Touch</h2>
                    <div className="max-w-md mx-auto text-center">
                        <p className="mb-8 text-lg text-gray-700 dark:text-slate-300">
